...
import 'package:myapp/models/kid_model.dart';
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage('assets/images/onboard1.gif'))),
            ),
            SizedBox(
              height: 10,
            ),
            Text('Hãy tuỳ chỉnh ứng dụng của bạn',
                style: AppFont.primaryFont, textAlign: TextAlign.center),
            SizedBox(height: 45),
            Text(
              'Đây là lần đầu tôi sử dụng',
              style: AppFont.primaryFont.copyWith(fontWeight: FontWeight.normal, fontSize: 15),
            ),
            SizedBox(
              height: 5,
            ),
            ElevatedButton(
                ...
                child: Text(
                  ...
                  style: AppFont.primaryFont
                      .copyWith(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600),
                )),
            SizedBox(
              height: 30,
            ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Nếu là sinh đôi, bạn có thể thêm hồ sơ em bé còn lại sau',
                    style: AppFont.primaryFont.copyWith(
                      fontSize: 16,
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          child: Image(
                            image: AssetImage('assets/images/boy-icon.png'),
                            width: 100,
                          )),
                    ],
                  ),
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        SharedPreferences prefs = await SharedPreferences.getInstance();
                        prefs.setString('genderBaby', gender);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Bạn có thể thay đổi những dữ liệu này sau',
                  style: AppFont.primaryFont.copyWith(
                    fontSize: 15,
                  ),
                ),
                ...
                Text(
                  'Tên em bé',
                  style: AppFont.primaryFont.copyWith(fontSize: 15, color: Colors.white),
                ),
                SizedBox(height: 10),
                TextField(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Bé được sinh ra vào khi nào?',
                style: AppFont.primaryFont.copyWith(fontWeight: FontWeight.w600),
              ),
              SizedBox(
                height: 10,
              ),
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                      onPressed: () async {
                        SharedPreferences prefs = await SharedPreferences.getInstance();
                        await prefs.setString('birthdayBaby', '$date');
...
class _AvatarBabyState extends State<AvatarBaby> {
  ...
  Future uploadFileAndSaveUrl() async {
    ...
    urlDowload = await ref.getDownloadURL();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Chọn ảnh yêu thích của bạn hoặc thêm ảnh sau',
                  style: AppFont.primaryFont.copyWith(fontSize: 15),
                ),
                SizedBox(height: 50),
                Row(
                              ...
                              if (urlDowload != '')
                                {
                                  Navigator.pushNamedAndRemoveUntil(
                                      context, "/createInfo", (route) => false)
                                }
                            },
                        style: ElevatedButton.styleFrom(
                            padding: EdgeInsets.only(top: 15, bottom: 15, right: 30, left: 30),
